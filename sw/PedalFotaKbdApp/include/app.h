...
#define APP_DIS_MANUFACTURER_NAME       ("PedalBLEkbd")
#define APP_DIS_MANUFACTURER_NAME_LEN   (strlen(APP_DIS_MANUFACTURER_NAME) + 1)

/* Model Number String Value */
#define APP_DIS_MODEL_NB_STR            ("KBD-BLE-1.0")
...
#define APP_DIS_SYSTEM_ID               ("\x27\x06\x19\x61\x02\x9A\xBC\xDE")
...
/* IEEE */
#define APP_DIS_IEEE                    ("\xDE\xAD\xBE\xEF\xDA\xDA")
...
#define APP_DIS_PNP_ID               ("\x02\x5E\x04\x41\x00\x00\x03")
